...
\usepackage{supporting_files/arxiv}
...
\usepackage{placeins}
\usepackage{booktabs}
\usepackage{chngcntr}   % appendix figure numbering
...
\input{supporting_files/math_commands}
...
\newtcolorbox[auto counter]{wrapbox}[2][]
{
  center,
  breakable,
  width = 1.09\linewidth,
  colframe = gray!25,
  colback  = gray!10,
  coltitle = black,  
...
% Uncomment to provide the publication venue
\renewcommand{\headeright}{Preprint}
\renewcommand{\undertitle}{}
% Uncomment to put a shorter title in the header
...
\hypersetup{
pdftitle={A formal theory of compositionality},
pdfsubject={Deep learning},
pdfauthor={Eric Elmoznino},
pdfkeywords={compositionality, complexity, deep learning, representation, generalization},
}
...
% that describe the representation in the 
